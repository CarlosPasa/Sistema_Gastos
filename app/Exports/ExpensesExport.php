...
class ExpensesExport implements FromCollection, WithHeadings, WithStyles, ShouldAutoSize, WithColumnFormatting, WithEvents
{
    ...
    */
    public function collection()
    {
        return Expense::with('category')
            ...
            ->get()
            ->map(fn ($expense) => [
                'Fecha' => \Carbon\Carbon::parse($expense->expense_date)
                        ->format('d/m/Y'),
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle('A1:D4')->getAlignment()->setVertical('center');
                ...
                $sheet->getStyle('D4:D' . $sheet->getHighestRow())
                    ->getNumberFormat()
