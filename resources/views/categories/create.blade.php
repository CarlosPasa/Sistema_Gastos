<x-app-layout>
    ...
    <div class="p-6">
        ...
        <x-form-card
            ...
            subtitle="Registra una nueva categoría para clasificar tus gastos">
            ...
            <form method="POST"
                ...
                <div class="mb-6">
                    ...
                    <textarea
                        ...
                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg
                               focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400">{{ old('description') }}</textarea>
